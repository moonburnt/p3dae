...
class AudioEffects:
    ...
    def fade_out(self, song, speed=0.5, stop: bool = True, reset_volume: bool = True):
        ...
        fade_out_interval = LerpFunctionInterval(
            song.set_volume, duration=speed, fromData=current_volume, toData=0
        )
    ...
    def fade_in(self, song, volume: float = 1.0, speed=0.5):
        ...
        fade_in_interval = LerpFunctionInterval(
            song.set_volume, duration=speed, fromData=0, toData=volume
        )
    ...
    def crossfade(
        self,
        song,
        active_songs: list = None,
        stop_active: bool = True,
        fade_in_volume: float = 1.0,
        ...
        parallel.append(
            Func(self.fade_in, song=song, volume=fade_in_volume, speed=fade_in_speed)
        )
